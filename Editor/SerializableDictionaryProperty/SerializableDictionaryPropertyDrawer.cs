using AceLand.Library.SerializableDictionaryModel;
using System;
...
namespace AceLand.Editor.SerializableDictionaryProperty
{
	...
	public class SerializableDictionaryPropertyDrawer : PropertyDrawer
	{
		...
		static readonly Dictionary<PropertyIdentity, ConflictState> s_conflictStateDict = new();
		...
		{
			if (value1 is Dictionary<string, object> dictionary && value2 is Dictionary<string, object> dictionary1)
			{
				var dict1 = dictionary;
				var dict2 = dictionary1;
